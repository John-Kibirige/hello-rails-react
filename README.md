...
<div align="center">
  ...
  <img src="https://user-images.githubusercontent.com/10421828/79436261-52159b80-7fd9-11ea-994e-2a98dd43e540.png" alt="logo" width="200"  height="auto" />
  <br/>
...
**Hello rails react** is a fullstack application that uses rails in the backend to generate api endpoints and react at the frontend to consume the apis created. Make makes this application different is the fact that the react is integrated into the rails application with the help of webpack.
...
- **This is fetched via a localhost url to be consumed by the react frontend**
...
- navigate to the rails-budget-app folder using ```cd hello-rails-react``` from the terminal
...
Feel free to check the [issues page](https://github.com/John-Kibirige//issues).
